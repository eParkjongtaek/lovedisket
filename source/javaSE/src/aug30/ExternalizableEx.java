...
public class ExternalizableEx implements Externalizable {
	...
	public void writeExternal(ObjectOutput objOutput)
		throws IOException {
	...
	public void readExternal(ObjectInput objInput)
		...
		//weight = ((Integer) objInput.readObject()).intValue();
	}
	...
	public static void main(String[] args) {
		ExternalizableEx ex1 = new ExternalizableEx("SSOL", 30, 100);
		FileOutputStream fos = null;
		ObjectOutputStream oos = null;
		FileInputStream fis = null;
		ObjectInputStream ois = null;
		try {
			fos = new FileOutputStream("C:\\data\\external.ser");
			oos = new ObjectOutputStream(fos);
			oos.writeObject(ex1);
			
			fis = new FileInputStream("C:\\data\\external.ser");
